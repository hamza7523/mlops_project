          ...
          <div className="relative w-full mt-10 max-w-xl mx-auto">
            {file && (
              <motion.div
                ...
                className={cn(
                  "relative overflow-hidden z-40 bg-neutral-900 flex flex-col items-start justify-start h-auto p-4 mt-4 w-full mx-auto rounded-md",
                  "shadow-sm"
                )}
              >
                <div className="flex justify-between w-full items-start gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="px-2 py-1 w-fit shrink-0 text-sm text-white"
                    >
...
export function GridPattern() {
  ...
  const rows = 11;
  return (
    <div className="flex bg-neutral-950 shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
